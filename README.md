...
| 💰 户部 | 尚书 | A股盘前分析、API 成本追踪、财务报表 |
| 🎭 礼部 | 尚书 | 小红书运营、文案创作、品牌推广 |
| 🔧 工部 | 尚书 | 服务器运维、CI/CD、基础设施巡检 |
| ⚖️ 刑部 | 尚书 | 开源合规、知识产权维权、合同审查 |
| 👔 吏部 | 尚书 | 项目管理、创业孵化、人事考核 |
| 📚 国子监 | 祭酒 | CS461 课程辅导、学习规划、知识整理 |
...
| 任务 | 频率 | 描述 |
|------|------|------|
| 📋 每日简报 | 每天 08:00 | 自动汇总 GitHub、天气、待办，推送到 Signal |
| 📊 A股盘前分析 | 工作日 09:15 | 户部自动拉取大盘数据，生成交易策略，推送 Discord + 微信 |
| 📜 起居注 | 每天 22:30 | 史官自动记录当日大事，写入 Notion 起居注数据库 |
| 🎭 礼部日报 | 每天 14:00 | 礼部汇报小红书/社媒运营数据 |
...
> 💡 **这不是 demo，是每天在用的生产系统。** 菠萝王朝已稳定运行数周，处理过数百个实际任务——从代码开发到维权调查，从A股分析到小红书运营。
